...
class RatchetWsServer implements MessageComponentInterface
{
    /**
     * Clients.
     *
    ...
    public function onMessage(ConnectionInterface $conn, $input)
    {
        ...
        if (isset($inputData['token'])) {
            ...
            $userSocket->socket_id = $conn->resourceId;
            $userSocket->token     = $inputData['token'];
    ...
    public function onClose(ConnectionInterface $conn)
    {
        ...
        UserSocket::whereSocketId($conn->resourceId)->delete();
    }
